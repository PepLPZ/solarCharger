  ...
  //  cuando el voltaje baje de los 10,5V
  //  
  //------------------------------------------------------------------------------
  ...
  // A5 - LCD SCL
  // D0 - NO USADA
  // D1 - ENTRADA DETECCION DE ESTADO DEL AMPLIFICADOR ON/OFF
...
#define AMPLI_PIN 1    // pin-1 is used to control the AMPLI ON/OFF
...
////////////////////////////////////CHARGE SET POINT //////////////////////////////////////////////
 void setpoint(void)
{
  temp_change =temperature-30.0; // 30 grados Celsius se toma como temperatura ambiente estándar
