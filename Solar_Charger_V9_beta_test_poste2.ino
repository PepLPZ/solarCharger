...
#define TRANSMISSION_INTERVAL 20000 // Defino el intervalo de tiempo que se enviarán las tramas LoRa 60000=1 Min. 300000=5 min.
...
////////////////////////////////////OBTENER LECTURAS DE SENSADO/////////////////////////////////////////
 void read_data(void) 
 {
   ...
   // Vout=Vin*R2/(R1+R2) => Vin = Vout*(R1+R2)/R2   R1=100 and R2=20
     ...
     load_current = ((read_adc(LOAD_CURRENT_ADC)*0.00502 - offsetVoltage -0.05)/Sensitivity );// VALORES MODIFICADOS PARA INDICAR CORRECTAMENTE
     //
     //
...
///  LA BATERIA ESTÉ ENTRE (10,2V Y 12,7V)                    ////
//--------------------------------------------------------------------
void fail_safe(void)
{
    if (bat_volt >= 10.2) // carga activada
    //low_Bat=0;
